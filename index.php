...
<head>
    ...
    <title>EJJI Coffee Corner</title>
    <style>
        .thumbnail {
            border: none;
...
<body>
    ...
    <nav class="navbar navbar navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <form class="d-flex">
                <a class="nav-link" style="color: #F2F1EF;" href="https://api.whatsapp.com/send?phone=6285161060878" tabindex="-1" target="_blank">Help +62 851-6106-0878</a>
            </form>
        </div>
    </nav>
    <!-- Head -->
