           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a  href="index.php"><i class="fa fa-dashboard fa-3x"></i> Produk</a></li>
                    <li><a  href="index.php"><i class="fa fa-dashboard fa-3x"></i> Pembelian</a></li>
                    <li><a  href="index.php"><i class="fa fa-dashboard fa-3x"></i> Pelanggan</a></li>
                    <li><a  href="index.php"><i class="fa fa-dashboard fa-3x"></i> Logout</a></li>
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">                       
                    <div class="panel panel-dark text-center no-boder bg-color-green">
                        <div class="panel-body">
                    ...
                    <div class="panel panel-dark text-center no-boder bg-color-red">
                        <div class="panel-body">
